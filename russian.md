...
### Локализация для steam-версии Dwarf Fortress

Инструменты для применения перевода к игре пока еще в разработке, есть ранние (очень ранние) версии патча. Более-менее стабильных сборок пока нет.

Сбор донатов для поддержки разразбочиков и тестовые версии патча:
